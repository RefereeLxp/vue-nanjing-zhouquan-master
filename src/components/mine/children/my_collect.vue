<template>
  <div class="my-list child-view">
    <div class="my-list-all">
      <header-pub class="white" headerTitle="我的收藏">
        <a class="share-tip"></a>
      </header-pub>
      <div class="my-list-box" v-if="optionCollect.length>0">
        <div class="my-list-info" v-for="(item, index) in optionCollect">
...
import { findCollectionByUserId} from '@/api/api.js' // 获取数据接口采用多条http请求
export default {
  mixins: [needMixin],
  components: {
    HeaderPub ,
